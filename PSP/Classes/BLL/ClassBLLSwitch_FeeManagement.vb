...
Public Class ClassBLLSwitch_FeeManagement
    ...
    Private _assignFeeSchema2CardAcceptor_responseCode As FeeSchemaService.responseCode
    Private _assignFeeSchema2CardAcceptor As New assignFeeSchema2CardAcceptor
    Private _cardAcceptor As New FeeSchemaService.cardAcceptorDTO

Imports SinaAcceptorManagementService
Imports Convertor

Public Class ClassBLLSwitch_SinaAcceptorManagement
    ...
    Public Sub OnlyAllocateTerminal()
        Try
            clsDalContract.BeginProc()
            clsDalContract.DDeviceID = Me.DeviceID
            clsDalContract.UpdateDevice_AfterSendToSina()
    ...
    End Sub
    Public Sub DefineCarAcceptorAllocateTerminal()
        Try
        ...
        End Try
    End Sub
    Public Sub SetTerminalToCancelled()
        Try
            clsDalSwitchSend.BeginProc()
            clsDalSwitchSend.Switch_Modify_DevicelID = Me.Switch_Modify_DeviceID
            clsDalSwitchSend.Update_Switch_Modify_Device_AfterSendToSina()
        ...
        End Try
    End Sub
    Public Sub ModifyTermianlSerial()
        Try
            clsDalSwitchSend.BeginProc()
    ...
    Public Sub ModifyCardAcceptor(ByVal FieldName As String, ByVal FieldValue As String)
        Try
            ...
            If dtSwitch_CardAcceptorIDInfo.Rows.Count > 0 Then
                ...
                clsDalSwitchSend.Update_Switch_Modify_AfterSendToSina()

                _acceptorManagementRq.cardAcceptor = _cardAcceptor
                _acceptorManagementRq.cardAcceptor.inst = _institution
                _acceptorManagementRq.cardAcceptor.setlAcnt = _externalAccount

                Dim CA As New SinaAcceptorManagementService.getCardAcceptorDetailByID
                Dim mhd As New SinaAcceptorManagementService.cardAcceptorDTO
                mhd.id = Me.Switch_CardAcceptorID
                Dim rq As New SinaAcceptorManagementService.acceptorManagementRq
                rq.cardAcceptor = mhd

Public Class frmBaseMakeFile

    Public Overridable Sub btnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView.Click
    End Sub

    Public Overridable Sub btnMakeFile_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMakeFile.Click
    End Sub

    Private Sub frmBaseMakeFile_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

...
Public Class frmRptMccMass
    ...
    Private Sub Print(ByVal Sender As System.Object)
        Try
            Dim sReportPath As String = Application.StartupPath.ToString + "\Reports" + "\rptMccMass.rpt"
            'sReportPath = "E:\Projects\EniacProjects\PSPWorkingDirectory\PSP\PSP\Reports\rptMccMass.rpt"

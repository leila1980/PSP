...
Public Class rptTransaction_Count_All
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptTransaction_Count_All.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTransaction_Count_All
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTransaction_Count_All = New rptTransaction_Count_All()
        rpt.Site = Me.Site
        Return rpt
    End Function

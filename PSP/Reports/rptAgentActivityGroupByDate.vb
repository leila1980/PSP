...
Public Class rptAgentActivityGroupByDate
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAgentActivityGroupByDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ChartType() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptAgentActivityGroupByDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAgentActivityGroupByDate = New rptAgentActivityGroupByDate()
        rpt.Site = Me.Site
        Return rpt
    End Function

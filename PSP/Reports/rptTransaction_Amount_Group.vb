...
Public Class rptTransaction_Amount_Group
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptTransaction_Amount_Group.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTransaction_Amount_Group
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTransaction_Amount_Group = New rptTransaction_Amount_Group()
        rpt.Site = Me.Site
        Return rpt
    End Function

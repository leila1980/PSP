...
Public Class rptTransaction_Amount_All
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptTransaction_Amount_All.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTransaction_Amount_All
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTransaction_Amount_All = New rptTransaction_Amount_All()
        rpt.Site = Me.Site
        Return rpt
    End Function

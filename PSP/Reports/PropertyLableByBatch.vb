...
Public Class PropertyLableByBatch
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PropertyLableByBatch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPropertyLableByBatch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PropertyLableByBatch = New PropertyLableByBatch()
        rpt.Site = Me.Site
        Return rpt
    End Function

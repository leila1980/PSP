...
Public Class rptReverseAfterCutOff
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptReverseAfterCutOff.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReverseAfterCutOff
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReverseAfterCutOff = New rptReverseAfterCutOff()
        rpt.Site = Me.Site
        Return rpt
    End Function

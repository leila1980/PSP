...
Public Class rptVisitorContracts
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptVisitorContracts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVisitorContracts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVisitorContracts = New rptVisitorContracts()
        rpt.Site = Me.Site
        Return rpt
    End Function

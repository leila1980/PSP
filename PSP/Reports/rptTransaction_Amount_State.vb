...
Public Class rptTransaction_Amount_State
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptTransaction_Amount_State.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Order() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptTransaction_Amount_State
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTransaction_Amount_State = New rptTransaction_Amount_State()
        rpt.Site = Me.Site
        Return rpt
    End Function
